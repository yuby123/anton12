"""
Django settings for ahmadsulthon project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-ueuti8p=@t!2kv@p3)zcsoc&ep&$v*s4_q%bv5+u-0b2k1&^s=')
...
ROOT_URLCONF = 'ahmadsulthon.urls'
...
WSGI_APPLICATION = 'ahmadsulthon.wsgi.application'
